        ...
        <div className="resume-matrix-wrapper">
            <table className="resume-matrix-table">
                ...
                {filteredResults.map((r, idx) => (
                    <tr key={idx} onClick={() => handleRowClick(r.user_id)} className="resume-matrix-row">
                    <td>{r.user_id}</td>
            ...
            {selectedResult && (
                <ResumeResultDetail result={selectedResult} onClose={() => setSelectedResult(null)} />
            )}
        </div>
    );
};
