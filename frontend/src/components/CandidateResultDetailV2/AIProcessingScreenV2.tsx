...
import "./AIProcessingScreenV2.css";
import { stepToMasterMap, resolveStepId } from "./progressStepsV2";
...
interface AIProcessingScreenV2Props {
  currentStatus: string;
  progressSteps: ProgressStep[];
  masterDefinitions: Record<string, MasterDefinition>;
}

const AIProcessingScreenV2: React.FC<AIProcessingScreenV2Props> = ({
  currentStatus,
  progressSteps,
  masterDefinitions,
}) => {
...
export default AIProcessingScreenV2;
