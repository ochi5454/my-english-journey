        ...
        .then(
            ...
            config: ConfigResponse & {
                ...
                setConfigData({
                    ...
                    titleOptions: config.titleOptions.map((opt: any) => ({
                        value: opt.value,
                        label: opt.label,
                    })),
                    hiringDecisions: config.hiringDecisions.map((opt: any) => ({
                        id: opt.id,
                        value: opt.value,
                    })),
                    ...
                    payTypeItems:
                        config.employmentTypes
                            ...
                            ?.filter((v: any, i: number, self: any[]) => self.findIndex((x: any) => x.value === v.value) === i) || [],
                });
            }
        )
