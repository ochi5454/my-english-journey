...
from backend.utils.encoding import detect_encoding
...
def parse_csv_to_cells(path: str) -> Tuple[List[Tuple[int, int, str]], List[str], str]:
    """
    CSVファイルをセルデータに変換

    エンコーディングを自動検出（UTF-8, Shift-JIS, CP932等に対応）
    """
    # エンコーディングを自動検出
